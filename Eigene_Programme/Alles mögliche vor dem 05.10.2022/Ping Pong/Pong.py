...
class Game:
    ...
    def draw(self):
        pygame.draw.rect(self.screen, pygame.Color(0, 255, 0), (self.p1_pos[0], self.p1_pos[1], 10, 100))
        pygame.draw.rect(self.screen, pygame.Color(0, 255, 0), (self.p2_pos[0], self.p2_pos[1], 10, 100))
        pygame.draw.rect(self.screen, pygame.Color(0, 255, 0), (self.ball_pos[0], self.ball_pos[1], 15, 15))
